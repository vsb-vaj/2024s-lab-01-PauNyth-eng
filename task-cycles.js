...
// ... write code ...
    let result = {
        array: array1.reduce((a, b) => a + b, 0) > array2.reduce((a, b) => a + b, 0) ? array1 : array2,
        sum: array1.reduce((a, b) => a + b, 0) > array2.reduce((a, b) => a + b, 0) ? array1.reduce((a, b) => a + b, 0) : array2.reduce((a, b) => a + b, 0)
    }
    return result;
};